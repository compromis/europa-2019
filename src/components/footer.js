    ...
    <div className="container-fluid">
      <div className="row">
        ...
        <div className="col-lg-6">
          ...
          Compromís, En Marea, Nueva Canarias, MÉS per Mallorca, Chunta Aragonesista, Partido Castellano, Iniciativa del Pueblo Andaluz,
          Izquierda Andalucista, Caballas, Coalición por Melilla, Verdes de Europa.
